                            ...
                            <div class="col-lg-12"> <!-- Removed the image column to focus on the form -->
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        @endif
                                     <form action="{{ route('admin.password.reset-password') }}" method="POST" class="user">
                                            @csrf
                                        ...
                                        <div class="form-group">
                                            <input name="password" type="password" id="password" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Enter Your New Password"> 
                                            @error('password')
                                            <strong class="text-danger">{{ $message }}</strong>
                                        @enderror
                                        </div>
                                        <div class="form-group">
                                            <input name="password_confirmation" type="password" id="password" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="Enter You New Pasword Confirmation"> 
                                        </div>
